...
infotambahan = "19.47"
generatorenable = false -- generator guest (true) / login (false)
selectedguest = false -- urut / terpilih
namagenerator = "aseprungkad"
kelipatanlogin = 3 -- batas bot pada satu socks5
maksimalercon = 15 -- maksimal try untuk dicap ercon

-- jika generatorenable false
namapatokan = "asheps" -- nama patokan bot

-- jika selectedguest true
listnumber = {
    "23", "24"
}

-- jika selectedguest false
mulailogin = 1 -- mulai bot, misal 1 = asheps1
...
function guest()
    if selectedguest then
        -- insert nama guest sesuai dari listnumber
        for i = 1, #listnumber do
            table.insert(guests, namapatokan .. listnumber[i])
        end
    else
